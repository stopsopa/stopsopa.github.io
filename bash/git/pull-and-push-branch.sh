...
/bin/bash $_DIR/is-this-branch.sh $source;
...
COMMAND="git --no-optional-locks -c color.branch=true -c color.diff=true -c color.status=true push -v --tags --set-upstream $remote refs/heads/$source:refs/heads/$target"

$COMMAND;

#COMMAND2="/bin/bash $_DIR/../headtail.sh 9 5 $COMMAND"
#
#$COMMAND2
