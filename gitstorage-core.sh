...
if [ "${?}" != "0" ]; then
    ...
    echo "${0} error: realpath_python.sh requires python"
...
do
 ...
 _TARGETGITDIR="$(python -c "import os,sys; print(os.path.abspath(sys.argv[1]))" "${_TARGETGITDIR}")"
