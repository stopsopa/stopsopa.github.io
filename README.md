...
[supported syntax](https://github.com/ajaxorg/ace/blob/v1.8.1/lib/ace/ext/modelist.js#L53) - (v1.8.1 seems to be last version having this file, look for update in new structure)
