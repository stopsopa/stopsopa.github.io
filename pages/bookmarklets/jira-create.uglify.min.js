  ...
  return (
    ...
    (function (r, t) {
      ...
      var e,
        ...
        u = !1;
      try {
        for (n = n.call(r); !(a = (e = n.next()).done); a = !0) {
          i.push(e.value);
    ...
    (function (r, t) {
      ...
      if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(r, t);
    })(r, t) ||
    (function () {
...
!(function () {
  ...
  function t(r, t) {
    ...
    t.o ? setTimeout(e, Number.isInteger(t.o) ? t.o : 1e3) : n.addEventListener("click", e);
    "function" == typeof t.i && t.i(n);
  }
  try {
    var r = (function (r, t) {
      var n = (t = t || document).querySelector(r);
      if (!n) throw new Error("cant find element by selector: " + r);
      return n;
    })("#project-field");
    r.style.maxWidth = "none";
    r.parentNode.style.maxWidth = "none";
    t("All good", { o: 200 });
  } catch (r) {
    t(r, { style: { minHeight: "200" } });
  }
})();
