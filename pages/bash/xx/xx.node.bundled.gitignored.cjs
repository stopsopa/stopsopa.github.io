...
var require_web_dom_exception_stack = __commonJS({
  "node_modules/core-js/modules/web.dom-exception.stack.js"() {
    ...
    var descriptor = NativeDOMException && DESCRIPTORS && Object.getOwnPropertyDescriptor(global3, DOM_EXCEPTION);
...
var require_structured_clone_proper_transfer = __commonJS({
  "node_modules/core-js/internals/structured-clone-proper-transfer.js"(exports2, module2) {
    ...
    var IS_DENO = require_engine_is_deno();
    var IS_NODE = require_engine_is_node();
    var structuredClone2 = global3.structuredClone;
...
var require_detach_transferable = __commonJS({
  "node_modules/core-js/internals/detach-transferable.js"(exports2, module2) {
    ...
    var structuredClone2 = global3.structuredClone;
    var $ArrayBuffer = global3.ArrayBuffer;
...
var require_web_structured_clone = __commonJS({
  "node_modules/core-js/modules/web.structured-clone.js"() {
    ...
    var Date = global3.Date;
    var Error2 = global3.Error;
    var TypeError2 = global3.TypeError;
    var PerformanceMark = global3.PerformanceMark;
    ...
    var checkNewErrorsCloningSemantic = function(structuredCloneImplementation) {
      return !fails(function() {
        var test = structuredCloneImplementation(new global3.AggregateError([1], PERFORMANCE_MARK, { cause: 3 }));
        return test.name !== "AggregateError" || test.errors[0] !== 1 || test.message !== PERFORMANCE_MARK || test.cause !== 3;
      });
    };
    var nativeStructuredClone = global3.structuredClone;
    ...
    var createDataTransfer = function() {
      var dataTransfer;
      try {
        dataTransfer = new global3.DataTransfer();
      } catch (error) {
        try {
          dataTransfer = new global3.ClipboardEvent("").clipboardData;
        } catch (error2) {
        }
      }
